...
public class ReserveService extends BaseService
{
	...
	{
	    String sql = "select a.check_time,a.mobile_phone,a.fund_account,a.reserve_price,a.product_code,b.product_name from t_mall_product_user_reserve a  left join T_MALL_PRODUCT_FINANCIAL b on a.product_code = b.product_code where a.id = ? and check_state = '1'";
