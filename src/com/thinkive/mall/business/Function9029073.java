...
public class Function9029073 extends BaseFunction
{
	/**
	 * <!-- 
					序号			id
...
银行代码		bank_no
	...
	{
		Logger log = Logger.getLogger(Function9029073.class);
		ResultVo resultVo = new ResultVo();
			try {
				...
				if(StringHelper.isEmpty(bank_no)){
					...
					resultVo.setErrorNo(-902907301);
					throw new InvokeException(-902907301,"银行编号不能为空");
				}
				...
				thrBankService.addThrBank(datarow);
				
			} catch (Exception e) {
				// TODO Auto-generated catch block
				resultVo.setErrorMsg(e.getMessage());
				resultVo.setErrorNo(-902907302);
				e.printStackTrace();
			}
		return resultVo;
	}
