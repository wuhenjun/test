...
public class Function902561 extends BaseFunction
{
...
//				}
				...
				String external_accounts_id =  SequenceGenerator.getInstance().getNextSequence("mall", "T_MALL_EXTERNAL_ACCOUNTS");
